...
def user_login(request):
        ...
        if form.is_valid():
            ...
            if user:
                ...
                if user.is_active:
                    ...
                    login(request,user)
                    if (user.groups.all() and  user.groups.first().name =='Optometrist'):
                        return HttpResponseRedirect(reverse('opto'))
                    else:
                        return HttpResponseRedirect(reverse('store'))
                else:
    ...
    return render(request ,'accounts/login.html' ,{'context':context, 'form' : form} )
...
def register(request):
    ...
    return render(request , 'accounts/register.html',{'context':context, 'form' : form})
...
def edit_profile(request):
    ...
    return render(request,'accounts/edit_profile.html',{'context':context,'user_form' : user_form, 'profile_form' : profile_form})
...
def profilepage(request,username):
    ...
    return render(request,'accounts/profilepage.html',{'context':context, 'ordered' : ordered, 'profile' : profile, 'user' : user})